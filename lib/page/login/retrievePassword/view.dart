...
class RetrievePassword extends StatelessWidget {
  ...
  /// 逻辑层
  final logic = Get.put(RetrievePasswordLogic());

  /// 数据层
  final state = Get.find<RetrievePasswordLogic>().state;
      ...
      child: Stack(
        children: [
          ...
          Positioned(
              right: 0,
              height: 90.dp,
              child: GetBuilder<RetrievePasswordLogic>(builder: (e) {
                return GestureDetector(
                  onTap: logic.empty,
    ...
    return SizedBox(
      ...
      child: Stack(
        children: [
          ...
          /// 获取验证码
          GetBuilder<RetrievePasswordLogic>(builder: (_) {
            return Positioned(
              top: 0.dp,
              right: 0.dp,
