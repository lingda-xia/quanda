...
/// 金币收益 页面
class GoldIncome extends StatelessWidget {
  GoldIncome({
    Key? key,
  }) : super(key: key);

  /// 逻辑层
  final logic = Get.put(GoldIncomeLogic());

  /// 数据层
  final state = Get.find<GoldIncomeLogic>().state;
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: TabBar(
            ...
            /// 指示器padding
            indicatorPadding:
                EdgeInsets.symmetric(horizontal: 35.dp, vertical: 16.dp),
